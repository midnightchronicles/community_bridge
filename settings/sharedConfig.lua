...
BridgeSharedConfig.Notify        = "auto"        -- [ auto | ox_lib | r_notify | wasabi_notify | lation_ui | okokNotify | mythic_notify | pNotify | t-notify | brutal_notify]
BridgeSharedConfig.HelpText      = "auto"        -- [ auto | ox_lib | jg-textui | cd_drawtextui | lab-HintUI | okokTextUI]
