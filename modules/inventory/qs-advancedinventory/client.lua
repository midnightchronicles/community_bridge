...
if GetResourceState('qs-advancedinventory') ~= 'started' then return end
...
Inventory.GetImagePath = function(item)
    ...
    local file = LoadResourceFile("qs-advancedinventory", string.format("html/images/%s.png", item))
    local imagePath = file and string.format("nui://qs-advancedinventory/html/images/%s.png", item)
